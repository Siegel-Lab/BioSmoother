...
export class UnsortedMultiChoiceView extends InputWidgetView {
  model: UnsortedMultiChoice
...
export namespace UnsortedMultiChoice {
...
export interface UnsortedMultiChoice extends UnsortedMultiChoice.Attrs {}

export class UnsortedMultiChoice extends InputWidget {
  properties: UnsortedMultiChoice.Props
  __view_type__: UnsortedMultiChoiceView

  constructor(attrs?: Partial<UnsortedMultiChoice.Attrs>) {
    super(attrs)
  }

  static init_UnsortedMultiChoice(): void {
    this.prototype.default_view = UnsortedMultiChoiceView

    this.define<UnsortedMultiChoice.Props>(({Boolean, Int, String, Array, Tuple, Or, Nullable}) => ({
      value:         [ Array(String), [] ],
