...
# serve bokeh
echo "starting bokeh server at: http://localhost:${port}/heatmap_server"
cd ..
...
bokeh serve heatmap_server/ --allow-websocket-origin=localhost:${port} --log-level error --port ${port}
