#!/bin/bash
#SBATCH srun --pty -p fat --mem 383G -J preprocess_heatmap --mail-user=markus.rainer.schmidt@gmail.com --mail-type END --time=240:00:00 -o slurm_preprocess_heatmap-%j.out
